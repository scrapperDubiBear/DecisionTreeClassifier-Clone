...
#0.28 -> divides training data into 21 samples
...
Y_pred = classifier.predict(X_test) 
from sklearn.metrics import accuracy_score
accuracyModel = accuracy_score(Y_test, Y_pred)
percentage = accuracyModel * 100
...
{1: 7, 2: 7, 3: 7}
21
X_11 <= 2.0 ? 0.3333333333333334
 left:3.0
 right:X_12 <= 750.0 ? 0.5
  left:2.0
  right:1.0
